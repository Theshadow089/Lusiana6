Locales['it'] = {
  ...
  ['boat_shop_confirm'] = 'compra <span style="color: yellow;">%s</span> per <span style="color: orange;">$%s</span>?',
  ...
  ['license_buy_no'] = 'no',
  ['license_buy_yes'] = 'acquista patente nautica <span style="color: green;">$%s</span>',
