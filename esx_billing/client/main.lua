...
Citizen.CreateThread(function()
    while true do
        ...
        if GetDistanceBetweenCoords(GetEntityCoords(ped), 435.12, -975.47, 30.72, 30.72, true) < 2 then
            ESX.ShowHelpNotification("Drücke ~INPUT_CONTEXT~ um deine Rechnungen zu bezahlen")
