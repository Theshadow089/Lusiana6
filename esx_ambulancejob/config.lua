...
Config.BleedoutTimer              = 120000 * 30 -- time til the player bleeds out
...
Config.RespawnPoints = {
	{coords = vector3(-433.75, -328.30, 34.91), heading = 307.74}
}
...
Config.Hospitals = {
	...
	CentralLosSantos = {
		...
		Blip = {
			coords = vector3(-461.2896, -288.9885, 78.1671),
			sprite = 61,
			scale  = 0.9,
			color  = 2
		},
		...
		Pharmacies = {
			vector3(-1823.4222, -380.8768, 48.4126)
		},
